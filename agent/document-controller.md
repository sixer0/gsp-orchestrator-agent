...
| `document-analyst` | Assess relevance, quality, gaps | `document-analyst-local` |
| `document-writer` | Create new documents | `document-writer-local` |
| `document-reader` | Extract from source documents | `document-reader-local` |
| `document-reviewer` | Integrate, revise, complete | `document-reviewer-local` |
| `document-converter` | Convert between formats | `document-converter-local` |
...
| RATE_LIMITED | Switch to *-local fallback |
